...
//print("The value of foo is \(foo)")
//Because foo variable is under for_in scope
...
//First print working inside for_in cicle ten times. Second print working only once after cicle is ended. Both prints working because variable x is global and modified inside cicle
